...
arch = [ 
    ...
    #block-001
    to_ConvConvRelu( name='ccr_b1', s_filer=572, n_filer=(3,3), offset="(0,0,0)", to="(0,0,0)", width=(2,2), height=40, depth=40, opacity=1.0 ),
    to_Pool(name="pool_b1", offset="(0,0,0)", to="(ccr_b1-east)", width=1, height=32, depth=32, opacity=1.0),
    ...
    *block_2ConvPool( name='b4', botton='pool_b3', top='pool_b4', s_filer=64,  n_filer=512, offset="(1,0,0)", size=(16,16,5.5), opacity=1.0 ),
    ...
    #Bottleneck
    #block-005
    to_ConvConvRelu( name='ccr_b5', s_filer=32, n_filer=(1024,1024), offset="(2,0,0)", to="(pool_b4-east)", width=(8,8), height=8, depth=8, caption="Bottleneck", opacity=1.0 ),
